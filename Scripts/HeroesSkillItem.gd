...
var first_hero_info: HeroInfo
var second_hero_info: HeroInfo
...
func show_first_hero():
	screen_manager.show_hero()
	player_screen.set_hero(first_hero_info)
	
func show_second_hero():
	screen_manager.show_hero()
	player_screen.set_hero(second_hero_info)
